...
class Wow_List_Table extends WP_List_Table {
	...
	public function column_title( $item ) {
		...
		$actions       = array(
			...
			'duplicate' => '<a href="' . esc_url( $duplicate_url ) . '" class="has-text-success">' . esc_attr__( 'Duplicate', 'counter_box' )
			               . '</a>',
			'delete'    => '<a href="' . esc_url( $delete_url ) . '" class="has-text-danger">' . esc_attr__( 'Delete', 'counter_box' ) . '</a>',
		);
	...
	public function get_columns() {
		$columns = array(
			...
			'title'  => esc_attr__( 'Title', 'counter_box' ),
			'code'   => esc_attr__( 'Shortcode', 'counter_box' ),
			'test'   => esc_attr__( 'Test Mode', 'counter_box' ),
			'status' => esc_attr__( 'Status', 'counter_box' ),
		);
	...
	private function table_data() {
		...
		if ( $result ) {
			foreach ( $result as $key => $value ) {
				...
				$test_on        = '<span class="has-text-danger has-text-weight-semibold">' . esc_attr__( 'On', 'counter_box' ) . '</span>';
