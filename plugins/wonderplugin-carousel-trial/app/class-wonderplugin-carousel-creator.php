...
class WonderPlugin_Carousel_Creator {
	...
	function render( $id, $configdata, $thumbnailsize, $titlefield ) {
		...
		<div id="wonderplugin-carousel-titlefield" style="display:none;"><?php echo $titlefield; ?></div>
		...
		?>
		<div id="wonderplugin-carousel-pagelist" style="display:none;"><?php echo htmlspecialchars(json_encode($pagelist)); ?></div>
		...
		?>
		<div id="wonderplugin-carousel-langlist" style="display:none;"><?php echo json_encode($langlist); ?></div>
		<div id="wonderplugin-carousel-defaultlang" style="display:none;"><?php echo $default_lang; ?></div>
		<div id="wonderplugin-carousel-currentlang" style="display:none;"><?php echo $currentlang; ?></div>
		<?php
			$initd_option = 'wonderplugin_carousel_initd';
		...
		<h3><?php _e( 'Carousel Editor', 'wonderplugin_carousel' ); ?></h3>

		<div style="margin:0 12px;">
		<ul class="wonderplugin-tab-buttons" id="wonderplugin-carousel-toolbar">
			<li class="wonderplugin-tab-button step1 wonderplugin-tab-buttons-selected"><span class="wonderplugin-icon">1</span><?php _e( 'Images & Videos', 'wonderplugin_carousel' ); ?></li>
			<li class="wonderplugin-tab-button step2"><span class="wonderplugin-icon">2</span><?php _e( 'Skins', 'wonderplugin_carousel' ); ?></li>
			<li class="wonderplugin-tab-button step3"><span class="wonderplugin-icon">3</span><?php _e( 'Options', 'wonderplugin_carousel' ); ?></li>
			<li class="wonderplugin-tab-button step4"><span class="wonderplugin-icon">4</span><?php _e( 'Preview', 'wonderplugin_carousel' ); ?></li>
			<li class="laststep"><input class="button button-primary button-hero" type="button" value="<?php _e( 'Save & Publish', 'wonderplugin_carousel' ); ?>"></input></li>
		</ul>
		...
		<ul class="wonderplugin-tabs" id="wonderplugin-carousel-tabs">
			<li class="wonderplugin-tab wonderplugin-tab-selected">
				...
				<div class="wonderplugin-toolbar">
					...
					<label><input type="button" class="button" id="wonderplugin-globalsettings" value="<?php _e( 'General Settings', 'wonderplugin_carousel' ); ?>" /></label>
					<label style="margin-right:4px;"><input type="button" class="button" id="wonderplugin-sortlist" value="<?php _e( 'Sort List', 'wonderplugin_carousel' ); ?>" /></label>
				...
				<div class="wonderplugin-carousel-media-table-help"><span class="dashicons dashicons-editor-help"></span>Click Above Buttons to Add Images, Videos or Posts</div>
				...
				<form>
					<fieldset>
						...
						$skins = array(
								...
								"imagetextbutton" => "Carousel with Image, Text and Button",
								"readmore" => "Read More",
								"hoverover" => "Hover Over",
								"flip" => "Flip",
								"readmorebutton" => "Read More Button",
								"htmlcontentslider" => "HTML Content Slider",
								"htmlcontentsliderwithtitle" => "HTML Content Slider with Title",
								"list" => "List",
								"teammember" => "Team Members with Social Media",
								"vertical" => "Vertical",
								"rotator" => "Rotator",
								"verticalscroller" => "Vertical Auto Scroll",
								"textcarouselslider" => "Text Carousel Slider",
								"teammemberflip" => "Team Members with Social Media and Flip Effect",
								"scroller" => "Auto Scroll",
								"scrollerjump" => "Auto Scroll with Jump Hover Over Effect",
								...
								"thumbnail" => "Thumbnail",
								"tworows" => "Two Rows",
								"firstlasthalf" => "Show Half of First and Last Item",
								"textlist" => "Vertical Text List",
								"textlistarrowstop" => "Vertical Text List with Arrows on Top"
								);
			...
			<li class="wonderplugin-tab">
				...
				<div class="wonderplugin-carousel-options">
					<div class="wonderplugin-carousel-options-menu" id="wonderplugin-carousel-options-menu">
						...
						<div class="wonderplugin-carousel-options-menu-item"><?php _e( 'Hoverover Effect', 'wonderplugin_carousel' ); ?></div>
					...
					<div class="wonderplugin-carousel-options-tabs" id="wonderplugin-carousel-options-tabs">
						...
						<div class="wonderplugin-carousel-options-tab wonderplugin-carousel-options-tab-selected">
							...
							<table class="wonderplugin-form-table-noborder">
								...
								<tr>
									<th>Size of Carousel Thumbnails (px)</th>
									<td><label><input name="wonderplugin-carousel-width" type="number" id="wonderplugin-carousel-width" value="300" class="small-text" /> by <input name="wonderplugin-carousel-height" type="number" id="wonderplugin-carousel-height" value="300" class="small-text" /> </label>
								</tr>

								<tr>
									<th>Carousel Padding (px)</th>
									<td>
										<label>Top: <input name="wonderplugin-carousel-paddingtop" type="number" id="wonderplugin-carousel-paddingtop" value="0" min="0" class="small-text" /></label>
										<label> Bottom: <input name="wonderplugin-carousel-paddingbottom" type="number" id="wonderplugin-carousel-paddingbottom" value="0" min="0" class="small-text" /></label>
										<label> Left: <input name="wonderplugin-carousel-paddingleft" type="number" id="wonderplugin-carousel-paddingleft" value="0" min="0" class="small-text" /></label>
										<label> Right: <input name="wonderplugin-carousel-paddingright" type="number" id="wonderplugin-carousel-paddingright" value="0" min="0" class="small-text" /></label>
									</td>
								</tr>

								<tr>
									<th>Thumbnail Resizing Options</th>
									<td>
									<label><input name='wonderplugin-carousel-fixaspectratio' type='checkbox' id='wonderplugin-carousel-fixaspectratio'  /> Resize and fill the thumbnail, crop the image if necessary</label>
									<label style="margin-left:12px;"><input name='wonderplugin-carousel-centerimage' type='checkbox' id='wonderplugin-carousel-centerimage'  /> Center image</label></p>
									<p>
									<label><input name='wonderplugin-carousel-fitimage' type='checkbox' id='wonderplugin-carousel-fitimage'  /> Resize and fit into the thumbnail</label>
									<label style="margin-left:12px;"><input name='wonderplugin-carousel-fitcenterimage' type='checkbox' id='wonderplugin-carousel-fitcenterimage'  /> Center fitted image</label>
									<label style="margin-left:12px;"><input name='wonderplugin-carousel-donotzoomin' type='checkbox' id='wonderplugin-carousel-donotzoomin'  /> Do not zoom in image if it is smaller than the thumbnail size</label></p>
									...
									<p><label><input name='wonderplugin-carousel-verticalflexheight' type='checkbox' id='wonderplugin-carousel-verticalflexheight'  /> Enable flexible height for vertical carousel</label></p>
									</td>
								</tr>
								...
								<tr>
									...
									<p><label><input name='wonderplugin-carousel-deferloading' type='checkbox' id='wonderplugin-carousel-deferloading'  /> Defer loading the carousel and the images after page load for (ms):  </label><input name="wonderplugin-carousel-deferloadingdelay" type="number" id="wonderplugin-carousel-deferloadingdelay" value="0" class="small-text" /></p>
									</td>
								</tr>
								...
								<tr>
									...
									<p><label><input name='wonderplugin-carousel-usebase64' type='checkbox' id='wonderplugin-carousel-usebase64'  /> Use base64 encoded 1 pixel transparent GIF as the preloaded image</label></p>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
									<p><label><input name='wonderplugin-carousel-addpreloading' type='checkbox' id='wonderplugin-carousel-addpreloading'  /> Display preloading animation for carousel images</label></p>
									<p><div>
											...
											<label>
												...
												<input type="button" class="button wonderplugin-select-mediaimage" data-inputname="wonderplugin-carousel-preloadingimagemode" data-displayid="wonderplugin-carousel-displaypreloadingimage" data-textid="wonderplugin-carousel-custompreloadingimage" value="Upload">
											</label>
											<br />
											<label>
								...
								<tr>
									<th>Speical Effect</th>
									<td><label><input name='wonderplugin-carousel-showfirstlasthalf' type='checkbox' id='wonderplugin-carousel-showfirstlasthalf'  /> Show half of first and last item in the carousel. Do not apply this effect when screen width is less than (px) : </label><input name="wonderplugin-carousel-firstlasthalfsmallscreen" type="number" id="wonderplugin-carousel-firstlasthalfsmallscreen" value="0" class="small-text" />
									</td>
								</tr>
									...
									<td>
										<div>
											...
											<label>
												...
												<input type="button" class="button wonderplugin-select-mediaimage" data-inputname="wonderplugin-carousel-arrowimagemode" data-displayid="wonderplugin-carousel-displayarrowimage" data-textid="wonderplugin-carousel-customarrowimage" value="Upload">
											</label>
											<br />
											<label>
								...
								<tr>
									...
									<p><label><input name='wonderplugin-carousel-hidebulletssmallscreen' type='checkbox' id='wonderplugin-carousel-hidebulletssmallscreen'  /> Hide navigation bullets when screen width is less than (px) </label><input name='wonderplugin-carousel-hidebulletssmallscreensize' type='number' class="small-text" id='wonderplugin-carousel-hidebulletssmallscreensize' value='480' /></p>
									</td>
								</tr>
								<tr>
									<th>Bullet image</th>
									<td>
										<div>
											...
											<label>
												...
												<input type="button" class="button wonderplugin-select-mediaimage" data-inputname="wonderplugin-carousel-navimagemode" data-displayid="wonderplugin-carousel-displaynavimage" data-textid="wonderplugin-carousel-customnavimage" value="Upload">
											</label>
											<br />
											<label>
						...
						<div class="wonderplugin-carousel-options-tab">
							<table class="wonderplugin-form-table-noborder">
								...
								<tr>
									...
									<p><label>Duration of moving one item (ms): <input name="wonderplugin-carousel-continuousduration" type="number" id="wonderplugin-carousel-continuousduration" value="2500" min="0" class="small-text" /></label></p>
									</td>
								</tr>
								...
								<tr>
									<th>Movement mode</th>
									<td><label>
										<select name='wonderplugin-carousel-movemode' id='wonderplugin-carousel-movemode'>
									...
									<p><label>Duration of movement other than Carousel Sliding: <input name="wonderplugin-carousel-moveduration" type="number" id="wonderplugin-carousel-moveduration" value="500" min="0" class="small-text" /></label></p>
									</td>
								</tr>
						...
						<div class="wonderplugin-carousel-options-tab">
							<table class="wonderplugin-form-table-noborder">
								...
								<tr>
									<th>Visible Items</th>
									<td><label><input name='wonderplugin-carousel-visibleitems' type='number' class='small-text' id='wonderplugin-carousel-visibleitems' value='3' /></label></td>
								</tr>
								...
								<tr>
									<th></th>
									<td>
									<label><input name='wonderplugin-carousel-limitvisibleitemstolength' type='checkbox' id='wonderplugin-carousel-limitvisibleitemstolength'  /> Limit the value of Visible Items to the number of carousel items</label>
									<p><label><input name='wonderplugin-carousel-hidearrowsandbulletsforonepage' type='checkbox' id='wonderplugin-carousel-hidearrowsandbulletsforonepage'  /> Hide left/right arrows and navigation bullets when there is only one page</label></p>
									</td>
								</tr>
							...
							<table class="wonderplugin-form-table-noborder">
								<tr>
									...
									<td>
										<div>
											<div>
											<p><label><input name='wonderplugin-carousel-showhoveroverlay' type='checkbox' id='wonderplugin-carousel-showhoveroverlay'  /> Show hover overlay image</label></p>
											</div>
											<div style="float:left;margin-right:12px;">
											<label>
											...
											<label>
												...
												<input type="button" class="button wonderplugin-select-mediaimage" data-inputname="wonderplugin-carousel-hoveroverlayimagemode" data-displayid="wonderplugin-carousel-displayhoveroverlayimage" data-textid="wonderplugin-carousel-customhoveroverlayimage" value="Upload">
											</label>
											<br />
											<label>
								...
								<tr>
									...
									<td>
										<div>
											<div>
											<p><label><input name='wonderplugin-carousel-showplayvideo' type='checkbox' id='wonderplugin-carousel-showplayvideo'  /> Show play button on video item</label></p>
											</div>
											<div style="float:left;margin-right:12px;">
											<label>
											...
											<label>
												...
												<input type="button" class="button wonderplugin-select-mediaimage" data-inputname="wonderplugin-carousel-playvideoimagemode" data-displayid="wonderplugin-carousel-displayplayvideoimage" data-textid="wonderplugin-carousel-customplayvideoimage" value="Upload">
											</label>
											<br />
											<label>
								...
								<tr>
									<th>Image Hover Over Effect</th>
									<td>
									<label><input name='wonderplugin-carousel-showimagehoverovereffect' type='checkbox' id='wonderplugin-carousel-showimagehoverovereffect'  /> Add image hover over effect</label>
									<select name='wonderplugin-carousel-imagehoverovereffect' id='wonderplugin-carousel-imagehoverovereffect'>
										  <option value="zoomin">Zoom In</option>
										  <option value="jump">Jump</option>
										  <option value="grayscale">Grayscale</option>
									</select>
									<p><textarea name='wonderplugin-carousel-imagehoverovercss' id='wonderplugin-carousel-imagehoverovercss' value='' class='large-text' rows="16"></textarea></p></td>
								</tr>
						...
						<ul class="wonderplugin-tabs-horizontal" id="wonderplugin-lightbox-panels">
							...
							<table class="wonderplugin-form-table-noborder">
								...
								<tr>
									...
									<p><label><input name='wonderplugin-carousel-lightboxinityoutube' type='checkbox' id='wonderplugin-carousel-lightboxinityoutube'  /> Initialise YouTube API</label></p>
									<p><label><input name='wonderplugin-carousel-lightboxinitvimeo' type='checkbox' id='wonderplugin-carousel-lightboxinitvimeo'  /> Initialise Vimeo API</label></p>
									</td>
								</tr>
							</table>
							</li>
						...
						<div class="wonderplugin-carousel-options-tab">
							<table class="wonderplugin-form-table-noborder">
								<tr>
									...
									<p><label><input name='wonderplugin-carousel-removeinlinecss' type='checkbox' id='wonderplugin-carousel-removeinlinecss'  /> Do not add CSS to HTML source code</label></p>
									</td>
								</tr>
								<tr>
									<th>Custom CSS</th>
