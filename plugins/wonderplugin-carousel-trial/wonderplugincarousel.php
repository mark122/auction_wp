<?php
/*
Plugin Name: Wonder Carousel Trial
...
if (defined('WONDERPLUGIN_CAROUSEL_VERSION'))
	return;

define('WONDERPLUGIN_CAROUSEL_VERSION', '18.4');
...
define('WONDERPLUGIN_CAROUSEL_PLUGIN_VERSION', '18.4');
...
class WonderPlugin_Carousel_Plugin {
	...
	public function init() {
		...
		if ( is_admin() )
		{
			...
			if ( get_option( 'wonderplugin_carousel_supportmultilingual', 1 ) == 1 )
				add_action( 'wp_ajax_wonderplugin_carousel_get_media_langs', array($this, 'wp_ajax_get_media_langs') );
		}
	...
	function register_menu()
	{
		...
		$menu = add_menu_page(
				__('Wonder Carousel Trial', 'wonderplugin_carousel'),
				__('Wonder Carousel Trial', 'wonderplugin_carousel'),
				$userrole,
		...
		$menu = add_submenu_page(
				'wonderplugin_carousel_overview',
				__('Tools', 'wonderplugin_carousel'),
				__('Tools', 'wonderplugin_carousel'),
				'manage_options',
	...
	{		
		...
		wp_register_style('wonderplugin-carousel-engine-css', WONDERPLUGIN_CAROUSEL_URL . 'engine/wonderplugincarouselengine.css', array(), WONDERPLUGIN_CAROUSEL_VERSION);
		wp_register_style('wonderplugin-carousel-admin-style', WONDERPLUGIN_CAROUSEL_URL . 'wonderplugincarousel.css', array(), WONDERPLUGIN_CAROUSEL_VERSION);
		wp_register_style('wonderplugin-carousel-socialmedia-style', WONDERPLUGIN_CAROUSEL_URL . 'engine/icons/css/mhfontello.css', array(), WONDERPLUGIN_CAROUSEL_VERSION);
	}
 ...
 * Uninstallation
 */
if ( !function_exists('wonderplugin_carousel_uninstall') )
{
