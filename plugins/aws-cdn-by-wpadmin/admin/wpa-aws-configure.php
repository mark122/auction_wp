...
<input id=wpawsactivatecsd  type='Button' data-domain=".esc_textarea($wpawscdndomain)." Value='Activate ".esc_textarea($wpawscdndomain)."' class='gsformbtn'>
</div>";
}
else
{
echo "<div class='gscols6'>
<input id=wpawsactivatecsd type='Button' Value='Activate ".esc_textarea($wpawscdndomain)."' DISABLED class='gsformbtndefault'>
</div>";
}
?>
