        ...
        <div class="row">
          ...
          <div class="first-part col-md-10 col-sm-12">
                ...
                <?php if (is_user_logged_in()) { ?>
                  <div id="dropdown-user-profile" class="ddmenu">
                    ...
                    <ul>
                      ...
                      <li class="h"><a href="<?php echo esc_url(get_permalink( get_option('woocommerce_myaccount_page_id') )); ?>"><i class="icon-layers icons"></i> <?php echo esc_html__('My Dashboard','ibid'); ?></a></li>
            ...
            <div class="col-md-2 menu-inquiry">
              <?php if (is_user_logged_in()) { ?> 
                <a class="button btn" href="<?php echo ibid_redux('inquiry_button_link'); ?>"><?php echo ibid_redux('inquiry_button_text'); ?></a>  
              <?php } else { ?>
                <a class="button btn" href="<?php echo esc_url(get_permalink( get_option('woocommerce_myaccount_page_id') )); ?>"><?php echo ibid_redux('inquiry_button_text'); ?></a>
              <?php } ?>
            </div>
        </div>
      </div>
