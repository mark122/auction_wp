        ...
        <div class="row">
          ...
          <div class="first-part col-md-10 col-sm-12">
            ...
            <div class="col-md-12 menu-holder">
             ...
             <div class="col-md-2 my-account-navbar" style="display:none;">
              <ul>
              <?php if ( class_exists('woocommerce')) { ?>
            ...
            <?php if (class_exists('WooCommerce')) { ?>
              <div class="col-md-2 menu-products" style="display:none;">
            <?php } else { ?>
              <div class="col-md-12 menu-products" style="display:none;">
            <?php } ?>
