                ...
                if ( $can_sell ) {
                    ...
                    if ( dokan_is_seller_enabled( get_current_user_id() ) ) { ?>
                        <form class="dokan-product-edit-form" role="form" method="post">
                                ...
                                <div class="content-half-part dokan-product-meta">
                                    ...
                                    if (class_exists('Dokan_Pro')) {
                                        if ( is_array( $product_types ) ){
                                            $auction_array = array('auction' => esc_html__('Auction', 'ibid'));
                                            if (!array_key_exists('auction', $product_types)) {
                                                $product_types = array_merge($product_types, $auction_array);
                                            }
                                        }
                                    }
                                    ?>
                            ...
                            <?php do_action('ibid_dokan_edit_product_before_short_description', $post->ID); ?>
